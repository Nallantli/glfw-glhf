...
gen.exe: main.o engine.o point3.o world.o polar.o surface.o QuickHull.o shader.o SimplexNoise.o
	$(CC) -o $@ main.o engine.o point3.o world.o polar.o surface.o QuickHull.o shader.o SimplexNoise.o $(LIBS)
